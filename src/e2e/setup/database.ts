...
export class TestDatabase {
  ...
  generateEnvFiles(): void {
    const userContainer = this.containers.get('user-service');
    const authContainer = this.containers.get('auth-service');
    const pointContainer = this.containers.get('point-service');

    // User Service .env.e2e
    if (userContainer) {
      const envContent = `# E2E Test Database Configuration (Generated by TestContainers)
# DO NOT EDIT MANUALLY - This file is automatically generated

DB_USER_SERVICE_HOST=${userContainer.getHost()}
DB_USER_SERVICE_PORT=${userContainer.getMappedPort(5432)}
DB_USER_SERVICE_NAME=user_service_db
DB_USER_SERVICE_USER=testuser
DB_USER_SERVICE_PASSWORD=testpass
`;
      fs.writeFileSync(path.join(__dirname, '../../user-service/.env.e2e'), envContent, 'utf8');
      console.log(`  ✓ Generated /workspaces/my-ws-demo/src/user-service/.env.e2e`);
    }

    // Auth Service .env.e2e (needs both auth-service and user-service DB info)
    if (authContainer && userContainer) {
      const envContent = `# E2E Test Database Configuration (Generated by TestContainers)
# DO NOT EDIT MANUALLY - This file is automatically generated

# Auth Service Database
DB_AUTH_SERVICE_HOST=${authContainer.getHost()}
DB_AUTH_SERVICE_PORT=${authContainer.getMappedPort(5432)}
DB_AUTH_SERVICE_NAME=auth_service_db
DB_AUTH_SERVICE_USER=testuser
DB_AUTH_SERVICE_PASSWORD=testpass

# User Service Database (for cross-service queries)
USER_SERVICE_DB_HOST=${userContainer.getHost()}
USER_SERVICE_DB_PORT=${userContainer.getMappedPort(5432)}
USER_SERVICE_DB_NAME=user_service_db
USER_SERVICE_DB_USER=testuser
USER_SERVICE_DB_PASSWORD=testpass
`;
      fs.writeFileSync(path.join(__dirname, '../../auth-service/.env.e2e'), envContent, 'utf8');
      console.log(`  ✓ Generated /workspaces/my-ws-demo/src/auth-service/.env.e2e`);
    }

    // Point Service .env.e2e
    if (pointContainer) {
      const envContent = `# E2E Test Database Configuration (Generated by TestContainers)
# DO NOT EDIT MANUALLY - This file is automatically generated

DB_POINT_SERVICE_HOST=${pointContainer.getHost()}
DB_POINT_SERVICE_PORT=${pointContainer.getMappedPort(5432)}
DB_POINT_SERVICE_NAME=point_service_db
DB_POINT_SERVICE_USER=testuser
DB_POINT_SERVICE_PASSWORD=testpass
`;
      fs.writeFileSync(path.join(__dirname, '../../point-service/.env.e2e'), envContent, 'utf8');
      console.log(`  ✓ Generated /workspaces/my-ws-demo/src/point-service/.env.e2e`);
    }

    // BFF用の.env.e2eファイルを生成（3つのサービスのDB情報を含む）
    const bffEnvPath = path.join(__dirname, '../../bff/.env.e2e');

    if (userContainer && authContainer && pointContainer) {
      const bffEnvContent = `# E2E Test Database Configuration for BFF (Generated by TestContainers)
# DO NOT EDIT MANUALLY - This file is automatically generated
...
# Service URLs (for BFF to call microservices)
USER_SERVICE_URL=http://localhost:8080
AUTH_SERVICE_URL=http://localhost:8081
POINT_SERVICE_URL=http://localhost:8082
`;

      fs.writeFileSync(bffEnvPath, bffEnvContent, 'utf8');
      console.log(`  ✓ Generated ${bffEnvPath}`);
    }
  }
